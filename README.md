...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? 
                 ...
                 Semantic html is about giving meaning to the webpage. With obvious elements b/ we know is body. 
                 p/ we know is for paragraph.    
                 makes the elements have more identification to css. 

2. Name two big differences between ```display: block;``` and ```display: inline;```. display:
        
                Block doesnt let elements sit side by side w/everything respected, Display inline doesnt respect the width and height

3. What are the 4 areas of the box model?

                Border, Margins, Padding, content.
...
5. Explain why git is valuable to a team of developers. 
                ...
                Being able to stage and commit with version control. 
                Able to go back and review and make changes. 
                Beable to branch out from a repository to add your on content to then 
                collaberate with others versions of the main repository.
